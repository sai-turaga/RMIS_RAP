CLASS zcl_grc_policy_control_fields DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_grc_policy_control_fields IMPLEMENTATION.
 METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    DATA : lt_original_data   TYPE STANDARD TABLE OF zc_grc_policy WITH DEFAULT KEY,
           lt_fieldname_range TYPE RANGE OF ztgrc_scr_contrl-fieldname.


      lt_original_data = CORRESPONDING #( it_original_data ).
      DATA(lv_record_type) =  VALUE #(   lt_original_data[ 1 ]-Recordtypeid OPTIONAL ).
