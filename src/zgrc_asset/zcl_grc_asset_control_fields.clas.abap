CLASS zcl_grc_asset_control_fields DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_grc_asset_control_fields IMPLEMENTATION.
 METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    DATA : lt_original_data   TYPE STANDARD TABLE OF zc_tgrc_asset WITH DEFAULT KEY,
